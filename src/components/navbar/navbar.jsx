    ...
    <Grid container sx={{ marginBottom: "4rem" }}>
      ...
      <Box
        sx={{
          position: "relative",
          zIndex: 0,
          backdropFilter: "blur(5px)", // Apply the blur effect to the content below the navbar
          "-webkit-backdrop-filter": "blur(5px)", // Add vendor prefix for Safari compatibility
          marginTop: "-4rem", // Adjust the margin to overlap the content with the navbar
